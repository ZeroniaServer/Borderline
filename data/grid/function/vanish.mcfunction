...
execute as @e[type=marker,tag=selected,limit=1,tag=!falling,tag=!fallen,tag=!ice] at @s run fill ~-2 ~ ~-2 ~2 ~ ~2 lime_concrete
execute as @e[type=marker,tag=selected,limit=1,tag=falling,tag=!fallen,tag=!ice] at @s run fill ~-2 ~ ~-2 ~2 ~ ~2 lime_concrete_powder
