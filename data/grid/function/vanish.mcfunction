...
execute as @e[type=marker,tag=vanished] at @s run fill ~-2 ~ ~-2 ~2 ~ ~2 air strict
execute as @e[type=marker,tag=selected,limit=1,tag=!falling,tag=!fallen,tag=!ice] at @s run fill ~-2 ~ ~-2 ~2 ~ ~2 lime_concrete strict
execute as @e[type=marker,tag=selected,limit=1,tag=falling,tag=!fallen,tag=!ice] at @s run fill ~-2 ~ ~-2 ~2 ~ ~2 lime_concrete_powder strict
execute as @e[type=marker,tag=selected,limit=1,tag=portal] at @s run function powerup:portaltile/setanchor
execute as @e[type=marker,tag=vanished,tag=ice] at @s run function powerup:icetile/vanish
