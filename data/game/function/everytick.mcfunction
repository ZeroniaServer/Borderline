...
execute as @a[gamemode=!spectator,team=Player,tag=!wall] at @s if block ~ ~-1 ~ tinted_glass run tag @s[predicate=custom:onground] add wall
execute as @a[gamemode=!spectator,team=Player,tag=!wall] at @s if block ~0.3 ~-1 ~ tinted_glass run tag @s[predicate=custom:onground] add wall
execute as @a[gamemode=!spectator,team=Player,tag=!wall] at @s if block ~-0.3 ~-1 ~ tinted_glass run tag @s[predicate=custom:onground] add wall
execute as @a[gamemode=!spectator,team=Player,tag=!wall] at @s if block ~ ~-1 ~0.3 tinted_glass run tag @s[predicate=custom:onground] add wall
execute as @a[gamemode=!spectator,team=Player,tag=!wall] at @s if block ~ ~-1 ~-0.3 tinted_glass run tag @s[predicate=custom:onground] add wall
execute as @a[gamemode=!spectator,team=Player,tag=!wall] at @s if block ~0.3 ~-1 ~0.3 tinted_glass run tag @s[predicate=custom:onground] add wall
execute as @a[gamemode=!spectator,team=Player,tag=!wall] at @s if block ~0.3 ~-1 ~-0.3 tinted_glass run tag @s[predicate=custom:onground] add wall
execute as @a[gamemode=!spectator,team=Player,tag=!wall] at @s if block ~-0.3 ~-1 ~-0.3 tinted_glass run tag @s[predicate=custom:onground] add wall
execute as @a[gamemode=!spectator,team=Player,tag=!wall] at @s if block ~-0.3 ~-1 ~0.3 tinted_glass run tag @s[predicate=custom:onground] add wall
