...
execute as @a[team=Border] unless entity @s[scores={armorcolor=2}] run item replace entity @s armor.head with leather_helmet{Unbreakable:1b,display:{Name:'[{"text":"Border Armor","color":"green","italic":false}]',color:48154},Enchantments:[{id:binding_curse,lvl:1}],HideFlags:1} 1
execute as @a[team=Border] unless entity @s[scores={armorcolor=2}] run item replace entity @s armor.chest with leather_chestplate{Unbreakable:1b,display:{Name:'[{"text":"Border Armor","color":"green","italic":false}]',color:48154},Enchantments:[{id:binding_curse,lvl:1}],HideFlags:1} 1
execute as @a[team=Border] unless entity @s[scores={armorcolor=2}] run item replace entity @s armor.legs with leather_leggings{Unbreakable:1b,display:{Name:'[{"text":"Border Armor","color":"green","italic":false}]',color:48154},Enchantments:[{id:binding_curse,lvl:1}],HideFlags:1} 1
