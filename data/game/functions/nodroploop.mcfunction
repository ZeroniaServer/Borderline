...
tag @p[team=Player,tag=!itemChecked] add itemChecking
...
execute unless entity @s[tag=itemFound] if entity @a[team=Player,tag=!itemChecked] run function game:nodroploop