...
execute as @e[type=marker,tag=current] at @s run fill ~-2 ~-1 ~-2 ~2 ~-1 ~2 moving_piston strict
execute as @e[type=marker,tag=current] at @s run fill ~-2 ~ ~-2 ~2 ~ ~2 frosted_ice[age=0] strict
