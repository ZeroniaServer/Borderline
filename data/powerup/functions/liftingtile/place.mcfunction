...
execute as @e[type=marker,tag=lifting,limit=1,sort=nearest] at @s positioned ~-2.55 ~ ~-2.55 as @a[dx=2.55,dy=4,dz=2.55] at @s run tp @s ~ ~2 ~
execute as @e[type=marker,tag=lifting,limit=1,sort=nearest] at @s positioned ~-2 ~ ~-2 as @e[type=item,dx=2,dy=4,dz=2] at @s run tp @s ~ ~2.5 ~
