...
execute as @e[type=marker,tag=lifting,limit=1,sort=nearest] at @s positioned ~-2.8 ~ ~-2.8 as @a[team=Player,dx=5.6,dy=4,dz=5.6] at @s run tp @s @s
execute as @e[type=marker,tag=lifting,limit=1,sort=nearest] at @s positioned ~-2.8 ~ ~-2.8 as @a[team=Player,dx=5.6,dy=4,dz=5.6] at @s run tp @s ~ ~4 ~
